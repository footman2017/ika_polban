...
<head>
    ...
    <link href="<?php echo base_url(); ?>/assets/plugins/bootstrap-tree/bootstrap-tree/css/bootstrap-tree.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="<?php echo base_url(); ?>/assets/plugins/bootstrap-tree/bootstrap-tree/js/bootstrap-tree.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>/assets/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js"></script>   
   
    <script src="<?php echo base_url(); ?>/assets/scripts/app.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>/assets/scripts/ui-tree.js" type="text/javascript"></script>
